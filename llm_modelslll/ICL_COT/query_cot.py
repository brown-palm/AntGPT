...
"put dough, put dough, take dough, take dough, take dough, put dough, adjust dough, adjust tray ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is baking bread. Future 20 actions are: take dough, put dough, roll dough, take cutter, cut dough, put cutter, take dough, put dough, take dough, put dough, take dough, put dough, take dough, put dough, take dough, take dough, put dough, take brush, hold bowl, take bottle ###\n",

"take plier, hold plant, cut plant, cut plant, throw plant, cut plant, hold plant, cut plant ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is prune plant. Future 20 actions are: hold plant, cut plant, cut plant, cut plant, put plier, take plier, cut stick, put stick, put shears, take bucket, pour soil, put bucket, break soil, take vase, pour soil, put vase, take soil, take soil, throw soil, take soil ###\n",

"take carrot, cut carrot, cut carrot, cut carrot, take carrot, put carrot, cut carrot, cut carrot ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is chop carrots. Future 20 actions are: cut carrot, take carrot, put carrot, cut carrot, cut carrot, put carrot, move carrot, take carrot, cut carrot, cut carrot, cut carrot, put carrot, cut carrot, cut carrot, cut carrot, take carrot, put carrot, put carrot, take carrot, cut carrot ###\n",

"put paper, put metal, take paper, adjust paper, put paper, adjust paper, take paintbrush, dip paintbrush ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is painting metal. Future 20 actions are: apply paper, dip container, apply paper, dip container, apply paper, dip container, apply paper, take paper, put paper, take paper, stick paper, smooth paper, take paper, put paper, fold paper, turn paper, smooth paper, turn paper, smooth paper, turn paper ###\n",

"take lid, close container, put container, close drawer, mix beverage, take bottle, put bottle, pet dog ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is make drink. Future 20 actions are: hold cup, open bottle, take bottle, close bottle, put bottle, mix beverage, push bottle, take cup, mix beverage, consume beverage, put cup, take bottle, put bottle, take cabinet, pour whisk, close bottle, put whisk, take bottle, open fridge, put bottle ###\n",

"tighten clamp, sand sander, sand wood, sand wood, wipe wood, sand wood, sand wood, sand wood ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is woodworking. Future 20 actions are: wipe wood, wipe wood, sand wood, wipe wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, wipe wood, wipe wood, sand wood, sand wood ###\n",

"take sponge, take soap, put sponge, put soap, take plate, wash plate, wash plate, put plate ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is clean dishes. Future 20 actions are: close faucet, take chopstick, adjust bag, adjust zucchini, hold pan, take napkin, clean countertop, put napkin, adjust zucchini, adjust zucchini, take napkin, put chopstick, open faucet, wash napkin, squeeze napkin, close faucet, clean napkin, put napkin, turn zucchini, take lid ###\n",

"take scissors, move cloth, put cloth, take cloth, put cloth, hold cloth, cut cloth, give scissors ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is Sew clothes. Future 20 actions are: give scissors, put scissors, lift cloth, put cloth, fold cloth, take cloth, attach cloth, put cloth, move cloth, adjust sewing-machine, adjust cloth, turn wheel, sew cloth, move cloth, take scissors, give scissors, give scissors, put scissors, adjust cloth, sew cloth ###\n",

"take dough, mold dough, put dough, take dough, mold dough, put dough, take dough, mold dough ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is make bread. Future 20 actions are: mold dough, put dough, take dough, mold dough, put dough, take dough, cut dough, put dough, put dough, put dough, put dough, take dough, cut dough, mold dough, put pan, adjust dough, take dough, cut dough, mold dough, put dough ###\n",

"put nut, put drill, take nut, screw nut, hold wheel, screw screw, hold screw, take drill ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is fix wheel. Future 20 actions are: insert screw, hold drill, put drill, take wrench, remove nut, insert nut, tighten nut, put bolt, take screwdriver, take nut, put screwdriver, insert screw, screw screw, insert screw, screw screw, screw screw, screw screw, shake wheel, put screwdriver, take wrench ###\n",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--response_name', type=str, default="subset600_responses_cot_recog.json", help="name of the output file")
    ...
    while not over:
        try:
            ...
            for ii, prompt_idx in enumerate(val_idx):
                ...
                for demo in demos:
                    prompt_message += demo
                prompt_message += val_x[prompt_idx] + " ##Q1: What's the scene according to previous actions? Q2: What are the future 20 actions based on the scene from Q1 and previous actions? => The scene is "
                ...
                for choice, i in zip(choices, range(len(choices))):
                    ...
                    try:
                        goal = choice["message"]["content"].strip().split(".")[0]
                        answer = choice["message"]["content"].strip().split(":")[1].strip().split(", ")
