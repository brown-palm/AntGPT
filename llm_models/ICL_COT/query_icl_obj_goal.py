...
demos = [
"observed objects: leaf, plant, cloth, sickle ## scene: gardening ## observed actions: tie leaf, carry leaf, put plant, adjust cloth, take plant, put plant, take sickle, take sickle => cut plant, put sickle, take leaf, stretch rubber, take sickle, cut plant, hold plant, put sickle, take rubber, pull rubber, take rubber, tie rubber, move plant, take rubber, pull rubber, put plant, hold plant, cut plant, cut plant, hold plant ###\n",

"observed objects: cement, mold, soil ## scene: making bricks ## observed actions: put cement, wipe mold, arrange mold, turn mold, put mold, take soil, pour mold, remove mold => put mold, wipe floor, cut cement, mix cement, arrange mold, put cement, remove cement, put cement, wipe cement, carry mold, put mold, turn mold, put mold, pour sand, put mold, cut clay, arrange mold, put clay, remove clay, carry mold ###\n",

"observed objects: dough, tray ## scene: baking bread ## observed actions: put dough, put dough, take dough, take dough, take dough, put dough, adjust dough, adjust tray => take dough, put dough, roll dough, take cutter, cut dough, put cutter, take dough, put dough, take dough, put dough, take dough, put dough, take dough, put dough, take dough, take dough, put dough, take brush, hold bowl, take bottle ###\n",

"observed objects: plier, plant ## scene: prune plant ## observed actions: take plier, hold plant, cut plant, cut plant, throw plant, cut plant, hold plant, cut plant => hold plant, cut plant, cut plant, cut plant, put plier, take plier, cut stick, put stick, put shears, take bucket, pour soil, put bucket, break soil, take vase, pour soil, put vase, take soil, take soil, throw soil, take soil ###\n",

"observed objects: carrot ## scene: chop carrots ## observed actions: take carrot, cut carrot, cut carrot, cut carrot, take carrot, put carrot, cut carrot, cut carrot => cut carrot, take carrot, put carrot, cut carrot, cut carrot, put carrot, move carrot, take carrot, cut carrot, cut carrot, cut carrot, put carrot, cut carrot, cut carrot, cut carrot, take carrot, put carrot, put carrot, take carrot, cut carrot ###\n",

"observed objects: paper, metal, paintbrush ## scene: painting metal ## observed actions: put paper, put metal, take paper, adjust paper, put paper, adjust paper, take paintbrush, dip paintbrush => apply paper, dip container, apply paper, dip container, apply paper, dip container, apply paper, take paper, put paper, take paper, stick paper, smooth paper, take paper, put paper, fold paper, turn paper, smooth paper, turn paper, smooth paper, turn paper ###\n",

"observed objects: lid, container, drawer, beverage, bottle, dog ## scene: make drink ## observed actions: take lid, close container, put container, close drawer, mix beverage, take bottle, put bottle, pet dog => hold cup, open bottle, take bottle, close bottle, put bottle, mix beverage, push bottle, take cup, mix beverage, consume beverage, put cup, take bottle, put bottle, take cabinet, pour whisk, close bottle, put whisk, take bottle, open fridge, put bottle ###\n",

"observed objects: clamp, sander, wood ## scene: woodworking ## observed actions: tighten clamp, sand sander, sand wood, sand wood, wipe wood, sand wood, sand wood, sand wood => wipe wood, wipe wood, sand wood, wipe wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, sand wood, wipe wood, wipe wood, sand wood, sand wood ###\n",

"observed objects: sponge, soap, plate ## scene: clean dishes ## observed actions: take sponge, take soap, put sponge, put soap, take plate, wash plate, wash plate, put plate => close faucet, take chopstick, adjust bag, adjust zucchini, hold pan, take napkin, clean countertop, put napkin, adjust zucchini, adjust zucchini, take napkin, put chopstick, open faucet, wash napkin, squeeze napkin, close faucet, clean napkin, put napkin, turn zucchini, take lid ###\n",

"observed objects: scissors, cloth ## scene: sew clothes ## observed actions: take scissors, move cloth, put cloth, take cloth, put cloth, hold cloth, cut cloth, give scissors => give scissors, put scissors, lift cloth, put cloth, fold cloth, take cloth, attach cloth, put cloth, move cloth, adjust sewing-machine, adjust cloth, turn wheel, sew cloth, move cloth, take scissors, give scissors, give scissors, put scissors, adjust cloth, sew cloth ###\n",

"observed objects: dough ## scene: make bread ## observed actions: take dough, mold dough, put dough, take dough, mold dough, put dough, take dough, mold dough => mold dough, put dough, take dough, mold dough, put dough, take dough, cut dough, put dough, put dough, put dough, put dough, take dough, cut dough, mold dough, put pan, adjust dough, take dough, cut dough, mold dough, put dough ###\n",

"observed objects: nut, drill, wheel, screw ## scene: fix wheel ## observed actions: put nut, put drill, take nut, screw nut, hold wheel, screw screw, hold screw, take drill => insert screw, hold drill, put drill, take wrench, remove nut, insert nut, tighten nut, put bolt, take screwdriver, take nut, put screwdriver, insert screw, screw screw, insert screw, screw screw, screw screw, screw screw, shake wheel, put screwdriver, take wrench ###\n",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--obj_name', type=str, default="obj_val600.json", help="name of the object file")
    ...
    obj_path = os.path.join(args.dataset_dir, args.obj_name)
    ...
    obj_list = json.load(open(obj_path,"r"))
    ...
    while not over:
        try:
            ...
            for ii, prompt_idx in enumerate(val_idx):
                ...
                for demo in demos:
                    prompt_message += demo
                prompt_message += "observed objects: "
                for obj in obj_list[prompt_idx]:
                    prompt_message += obj + ", "
                prompt_message = prompt_message[:-2]
