...
dicts = json.load(open("dataset/v2_dicts.json","r"))
val_words = json.load(open("dataset/v2_val_words_nseg8.json","r"))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_name', type=str, default="v2_train_nseg8.jsonl", help="name of the training file")
    parser.add_argument('--val_name', type=str, default="v2_val_nseg8_recog.jsonl", help="name of the validation file")
    parser.add_argument('--similar_matrix_name', type=str, default="v2_similar_matrix.pkl", help="name of the similar matrix file")
        ...
        for jdx, choice in enumerate(answer):
            ...
            for a in actions:
                ...
                try:
                    ...
                    real_noun = ""
                    for word in words:
                        if word in verb_to_index.keys():
                            real_verb = word
                            break
                        else:
                            real_verb = "take"
                    for word in words:
                        if word in noun_to_index.keys():
                            real_noun = word
                            break
                        else:
                            real_noun = "dough"
