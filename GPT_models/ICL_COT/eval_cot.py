...
if __name__ == "__main__":
    ...
    parser.add_argument('--similar_matrix_name', type=str, default="similar_matrix_subset600.pkl", help="name of the similar matrix file")
    ...
    for response in responses_list:
        ...
        for choice in response:
            try:
                goal = choice.strip().split(".")[0]
                answer = choice.strip().split(":")[1].strip().split(", ")
